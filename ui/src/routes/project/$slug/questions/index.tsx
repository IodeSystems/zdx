...
import {BoxLink, ChipLink} from '../../../../components/BoxLink'
            ...
            <Paper variant="outlined" sx={{
                ...
                <Box sx={{display: 'flex', alignItems: 'center', gap: 1, mb: 0.5}}>
                    ...
                    {item.parent_question_id && (
                        <Chip label={`variation of #${item.parent_question_id}`} size="small" variant="outlined"
                              color="info"/>
                    )}
                </Box>
                <BoxLink
                        ...
                        <Stack spacing={1}>
                            ...
                            <Box>
                                <Button type="submit" variant="contained" size="small"
                                        disabled={createQuestion.isPending || !variationText.trim()}>
