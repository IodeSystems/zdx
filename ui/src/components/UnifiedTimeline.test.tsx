...
vi.mock('../api', async () => {
  ...
  return {
    ...actual,
    useReservationsByIssue: vi.fn(),
    useIssueResolutions: vi.fn(),
    useHistory: vi.fn(),
    useComments: vi.fn(),
    useMarkCommentsRead: vi.fn(),
  }
})
...
const mockedUseReservations = vi.mocked(useReservationsByIssue)
const mockedUseResolutions = vi.mocked(useIssueResolutions)
const mockedUseHistory = vi.mocked(useHistory)
const mockedUseComments = vi.mocked(useComments)
const mockedUseMarkRead = vi.mocked(useMarkCommentsRead)

let queryClient: QueryClient

beforeEach(() => {
  queryClient = new QueryClient({ defaultOptions: { queries: { retry: false } } })
  mockedUseMarkRead.mockReturnValue({ mutate: vi.fn(), isPending: false } as any)
})
