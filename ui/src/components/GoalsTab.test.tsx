...
vi.mock('../api', async () => {
  ...
  return {
    ...
    useUpdateGoal: vi.fn(),
    useDeleteGoal: vi.fn(),
    useCreateConstraint: vi.fn(),
    useUpdateConstraint: vi.fn(),
    useDeleteConstraint: vi.fn(),
  }
})
...
const mockedUseConstraints = vi.mocked(useConstraints)
const mockedUseCreateGoal = vi.mocked(useCreateGoal)
const mockedUseUpdateGoal = vi.mocked(useUpdateGoal)
const mockedUseDeleteGoal = vi.mocked(useDeleteGoal)
const mockedUseCreateConstraint = vi.mocked(useCreateConstraint)
const mockedUseUpdateConstraint = vi.mocked(useUpdateConstraint)
const mockedUseDeleteConstraint = vi.mocked(useDeleteConstraint)
